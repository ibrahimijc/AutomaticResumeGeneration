...
const LoginPage: NextPage = () => {
  ...
  const onSubmit = (data: FormData) => {
    axios
      .post('https://resume.depchip.com/api/v1/User/Login', data)
      .then((response) => {
      ...
      <div className="form">
        ...
        >
          <Form className="formContainer">
            ...
            <label className="inputLoginPage" htmlFor="email"> </label>
              Email: &nbsp;
            ...
            <br />
            <div className="mt-2">
              <label className="inputLoginPage" htmlFor="password">     </label>
                Password: &nbsp;
            ...
            <div className="flex justify-center  gap-2 mt-5">
              ...
              <div onClick={routeregister} className="register">
                {' '}
                Register Here
              </div>
            </div>
            <div className=" mt-5 new">
              By continuing, you agree to HumpBack's <span className="spantext">Terms of Use</span>{' '}
              and confirm that you have read the <span className="spantext">Privacy Policy</span>
            </div>
          </Form>
        </Formik>
      </div>
